    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdministratorApprovals", x => x.ApprovalId);
                    table.ForeignKey(
                        name: "FK_AdministratorApprovals_AspNetUsers_AdminUserId",
                        column: x => x.AdminUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AdministratorApprovals_AspNetUsers_ApprovedByAdminId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComplaintImages", x => x.ImageId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdministratorApprovals_AdminUserId",
                table: "AdministratorApprovals",
                column: "AdminUserId");

            migrationBuilder.CreateIndex(
                name: "IX_AdministratorApprovals_ApprovedByAdminId",
                table: "AdministratorApprovals",
